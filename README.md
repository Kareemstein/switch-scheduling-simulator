...
This project explores the behavior of high-performance network switches and packet-level processing through a set of C++ simulations and utilities. It focuses on modeling switching algorithms, analyzing throughput and latency, and implementing low-level IP packet handling.
...
Useful for understanding scalability and efficiency trade-offs
...
This project was developed as part of academic work in high-speed networks and systems programming, with a focus on understanding how modern network switches operate and how packet processing is implemented at a low level.
